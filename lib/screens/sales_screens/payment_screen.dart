      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest request) {
            if (request.url.startsWith('https://api.productq.app/api/v1/subscription/success')) {
              MyConsts.isPurchased = true;
              GoRouter.of(context).pushNamed(MyAppRouteConst.paymentSuccessRoute);
            }
            if(request.url.startsWith('https://api.productq.app/api/v1/subscription/failure')) {
